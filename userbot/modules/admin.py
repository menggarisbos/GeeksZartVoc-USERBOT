...
# =================== CONSTANT ===================
PP_TOO_SMOL = "`Gambar Terlalu Kecil kaya tititlu`"
PP_ERROR = "`Gagal Memproses Gambar bokep`"
NO_ADMIN = "`Maaf Anda Bukan Admin grup bokep:)`"
NO_PERM = "`Maaf Anda jomlo!`"
NO_SQL = "`Berjalan Pada Mode Non-SQL`"

CHAT_PP_CHANGED = "`Berhasil Mengubah Profil Grup menjadi alay`"
CHAT_PP_ERROR = (
    "`Ada Masalah Dengan Memperbarui Foto karena lu belum mandi,`"
    "`Mungkin Karna Anda Bukan Admin bokep,`"
    "`Atau Tidak Mempunyai Izin coli.`"
)
...
CMD_HELP.update(
    {
        "admin": "𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.jadiadmin` <username/balas ke pesan> <nama title (optional)>"
        "\n↳ : Mempromosikan member sebagai admin."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.unadmin` <username/balas ke pesan>"
        "\n↳ : Menurunkan admin sebagai member."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.blokir` <username/balas ke pesan> <alasan (optional)>"
        "\n↳ : Memblokir Seseorang."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.bukalokir <username/reply>`"
        "\n↳ : Menghapus Blokir."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.bisukan` <username/balas ke pesan> <alasan (optional)>"
        "\n↳ : Membisukan Seseorang Di Grup, Bisa Ke Admin Juga."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.unmute` <username/balas ke pesan>"
        "\n↳ : Membuka bisu orang yang dibisukan."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.bisuglobal` <username/balas ke pesan> <alasan (optional)>"
        "\n↳ : Membisukan ke semua grup yang kamu punya sebagai admin."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.bukabisuglobal` <username/reply>"
        "\n↳ : Reply someone's message with `.ungmute` to remove them from the gmuted list."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.akunterhapus`"
        "\n↳ : Untuk mencari akun terhapus dalam grup."
        "Gunakan `.akunterhapus clean` untuk menghapus Akun Terhapus dari grup."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.all member`"
        "\n↳ : Tag semua member dalam grup."
        "\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `.daftar admin`"
